     ...
     <PolicyLayout title="Privacy Policy">
       <div className="space-y-8 text-muted-foreground">
         ...
         <section>
           ...
           <p>
             This Privacy Policy describes how NythicAI and its affiliates (collectively "NythicAI, we, our, us")
             collect, use, share, protect or otherwise process your information/ personal data through our website
             https://nythicai.com (hereinafter referred to as Platform). Please note that you may be able to browse
         ...
         {/* Collection */}
         <section>
           <h2 className="text-lg font-semibold text-foreground mb-3">Collection</h2>
           <p>
             ...
             receive an email, a call from a person/association claiming to be NythicAI seeking any personal data like
         ...
         {/* Sharing */}
         <section>
           <h2 className="text-lg font-semibold text-foreground mb-3">Sharing</h2>
           <p>
         ...
         <section>
           <h2 className="text-lg font-semibold text-foreground mb-3">Security Precautions</h2>
           <p>
         ...
         <section>
           <h2 className="text-lg font-semibold text-foreground mb-3">Data Deletion and Retention</h2>
           <p>
             ...
             information provided below to assist you with these requests. We may in event of any pending grievance,
             claims, pending shipments or any other services we may refuse or delay deletion of the account. Once the
         ...
         <section className="bg-muted/50 p-6 rounded-lg">
           ...
           <div className="space-y-2">
             <p>
               <strong>Name:</strong> Manjunath Krishna Mane
             </p>
             <p>
               <strong>Designation:</strong> Grievance Officer
             </p>
             <p>
               <strong>Company:</strong> Ravi Industries
             </p>
             <p>
               <strong>Address:</strong> SM1, Lakkamanhalli, Hubli Road, Dharwad Karnataka 580004
             </p>
             <p>
