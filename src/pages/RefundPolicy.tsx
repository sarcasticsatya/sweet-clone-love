      ...
      <div className="space-y-6 text-muted-foreground">
        ...
        <ol className="list-decimal list-outside ml-6 space-y-4">
          ...
          <li>
            ...
            bring it to the notice of our customer service within <strong>7 days</strong> of receiving the product. The
          ...
          <li>
            ...
            processed to you, the amount will be credited to your original payment mode.
          </li>
        </ol>
