...
export const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-background via-primary/5 to-background animate-gradient">
      ...
      <div className="relative z-10 text-center space-y-8 px-4 max-w-4xl mx-auto">
        ...
        <div className="flex justify-center animate-fade-in-up">
          <div className="w-24 h-24 md:w-32 md:h-32 bg-primary rounded-3xl flex items-center justify-center p-3 glow-primary shadow-2xl">
        ...
        <div className="space-y-4 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="flex items-center justify-center gap-2 text-primary font-medium text-lg md:text-xl">
